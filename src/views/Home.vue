		...
		<article v-if="showHome">
			<main class="home">
				...
				<section class="second-section"
						 ref="parallax2"
						 data-lax-bg-pos-y="1400 120, 700 0">
					<home-box-second />
					<svg class="second-wave"
						 viewBox="0 0 1440 320">
						<path fill="#fff"
							  fill-opacity="1"
				...
				<section class="third-section"
						 ref="parallax3"
						 data-lax-bg-pos-y="3600 1000, 700 0">
...
.second-section::after {
	...
	background: linear-gradient(0deg, #0a0f23 0%, #5111e0 100%);
	width: 100%;
	height: 100%;
	position: absolute;
	top: 0;
